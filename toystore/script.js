const toys = {
  outdoor: [
    ...
    },
    {
      ...
      description: "Football is a racket sport...",
    },
    {
      id: 3,
      name: "Basketball",
      ...
      description: "Basketball is a racket sport...",
    },
    {
      id: 4,
      name: "Cricket",
      ...
      description: "Cricket is a racket sport...",
    },
    {
      id: 5,
      name: "Volleyball",
      ...
      description: "Volleyball is a racket sport...",
    },
    {
      id: 6,
      name: "Batmiton",
      ...
      description: "Batmiton is a racket sport...",
    },
  ],
  educational: [
    {
      ...
      description: "The abacus (plural abaci or abacuses)...",
    },
    {
      id: 8,
      name: "Ring Tower Toy",
      ...
      description: "The Ring tower (plural abaci or abacuses)...",
    },
    {
      id: 9,
      name: "Chess",
      ...
      description: "The chess (plural abaci or abacuses)...",
    },
    {
      id: 10,
      name: "Rubik's Cube",
      ...
      description: "The Rubik's cube (plural abaci or abacuses)...",
    },
    {
      id: 11,
      name: "Puzzle",
      ...
      description: "The puzzle (plural abaci or abacuses)...",
    },
    {
      id: 12,
      name: "Alphabet Board",
      ...
      description: "The Alphabet Board (plural abaci or abacuses)...",
    },
  ],
  "small-toys": [
    {
      ...
      description: "The entire body of the pen is a slow recovery squishy...",
    },
    {
      id: 14,
      name: "Unicorn",
    ...
    },
    {
      ...
      price: 4.99,
      image:
        "https://firsthub.in/public/uploads/all/a9yL2vldDEBdKdIKfhecCcGaTfEiQGpEGxZcuMGL.jpg",
      description: "The entire body of the pen is a slow recovery squishy...",
    },
    {
      id: 16,
